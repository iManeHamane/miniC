...
public class Return implements Instruction {
	...
	public boolean checkType() {
		...
		//return this.value.getType().compatibleWith(SymbolTable.functionDeclaration.getType());
		return this.value.getType()!=AtomicType.ErrorType;
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		int len = this.value.getType().length();
		f.add(_factory.createReturn(len,len));
		return f ;
	}
